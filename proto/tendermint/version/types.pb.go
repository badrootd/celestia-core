...
// source: badrootdcelestiacore.version/types.proto
...
func init() {
	proto.RegisterType((*App)(nil), "badrootdcelestiacore.version.App")
	proto.RegisterType((*Consensus)(nil), "badrootdcelestiacore.version.Consensus")
}

func init() { proto.RegisterFile("badrootdcelestiacore.version/types.proto", fileDescriptor_f9b42966edc5edad) }
